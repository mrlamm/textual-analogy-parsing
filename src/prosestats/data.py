...
#def generate_title(frame):
#    """
#    Rule based generation of a graph title.
#    """
#    ret = ""
#    if frame.possessor:
#        ret += "{}'s ".format(frame.possessor)
#    if frame.theme:
#        ret += "{} ".format(frame.theme)
#    if frame.theme_mod:
#        ret += "{} ".format(frame.theme_mod)
#    return ret
#
...
#
#    title = ""
#    title_ = generate_title(frame)
#    assert title == title_
#
#def convert_to_plot(frame):
#    """
#    Converts a single frame into a graph.
#    """
#    title = generate_title(frame)
#    unit = frame.unit or "number"
#
